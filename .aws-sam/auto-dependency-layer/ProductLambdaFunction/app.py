...
def get_products():
    ...
    while True:
        if last_evaluated_key:
            response = table.scan(
                FilterExpression=Attr('PK').begins_with('PRODUCT#') & Attr('SK').begins_with('PRODUCT#'),
                ExclusiveStartKey=last_evaluated_key
            )
        else:
            response = table.scan(FilterExpression=Attr('PK').begins_with('PRODUCT#') & Attr('SK').begins_with('PRODUCT#'))
